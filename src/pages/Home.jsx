...
import { Briefcase, Calendar, Globe, GraduationCap, Users } from "lucide-react";
      ...
      <section className="bg-blue-600 text-white py-16 mt-20">
        <div className="container mx-auto flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            <Button
              variant="outline"
              className="flex items-center justify-center text-para border-white hover:bg-white hover:text-blue-700 px-4 py-2"
            >
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            <img src={Image2} alt="Admissions" className="w-full h-auto" />
          </div>
        </div>
      </section>
